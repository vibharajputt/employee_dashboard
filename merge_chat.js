const fs = require('fs');
let appJs = fs.readFileSync('D:/employee_dashboard/app.js', 'utf8');
...
// Insert socket logic at the top
appJs = appJs.replace('const DEFAULT_USERS = [];', socketLogic + '\nconst DEFAULT_USERS = [];');

// Insert renderChatTab logic at the end of the file
appJs = appJs + '\n' + renderChatTab;

// Update switchTab function to handle chat
appJs = appJs.replace('else if (tabId === "attendance") {\\n    renderAttendanceTab();\\n  }', 
'else if (tabId === "attendance") {\\n    renderAttendanceTab();\\n  }\\n  else if (tabId === "chat") {\\n    renderChatTab();\\n  }');

fs.writeFileSync('D:/employee_dashboard/app.js', appJs);
